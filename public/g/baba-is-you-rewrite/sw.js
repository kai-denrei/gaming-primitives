...
const PRECACHE = `baba-is-you-rewrite_precache_${CACHE_VERSION}`;
const RUNTIME  = `baba-is-you-rewrite_runtime_${CACHE_VERSION}`;
...
self.addEventListener('activate', (event) => {
  event.waitUntil((async () => {
    ...
    await Promise.all(keys
      .filter(k => k.startsWith('baba-is-you-rewrite_') && k !== PRECACHE && k !== RUNTIME)
