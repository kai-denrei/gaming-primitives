...
const PRECACHE = `lunar-lander-thrust_precache_${CACHE_VERSION}`;
const RUNTIME  = `lunar-lander-thrust_runtime_${CACHE_VERSION}`;
...
self.addEventListener('activate', (event) => {
  event.waitUntil((async () => {
    ...
    await Promise.all(keys
      .filter(k => k.startsWith('lunar-lander-thrust_') && k !== PRECACHE && k !== RUNTIME)
