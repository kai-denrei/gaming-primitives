...
const PRECACHE = `boulder-dash-falling-rocks_precache_${CACHE_VERSION}`;
const RUNTIME  = `boulder-dash-falling-rocks_runtime_${CACHE_VERSION}`;
...
self.addEventListener('activate', (event) => {
  event.waitUntil((async () => {
    ...
    await Promise.all(keys
      .filter(k => k.startsWith('boulder-dash-falling-rocks_') && k !== PRECACHE && k !== RUNTIME)
